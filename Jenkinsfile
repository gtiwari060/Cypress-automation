pipeline{
    ...
    post{
        always{
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, icon: '', keepAll: true, reportDir: 'report/', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
        }
    }
}